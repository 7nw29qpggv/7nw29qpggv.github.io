...
$e_subject = 'Website message by ' . $name . '.';
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<p>Thank you <strong>$name</strong>, your message has been submitted. I will contact you as soon as possible.</p>";
	echo "</div>";
	echo "</fieldset>";
